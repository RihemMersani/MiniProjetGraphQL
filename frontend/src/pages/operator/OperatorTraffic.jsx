...
function OperatorTraffic() {
  ...
  return (
    <OperatorLayout
      title="Trafic"
      subtitle="Surveillance dynamique des zones de circulation"
    >
      ...
      <div className="box">
        <h2>Mesurer la densité du trafic</h2>
        ...
        <form className="form traffic-form" onSubmit={handleAddZone}>
          ...
          <button type="submit">Enregistrer mesure</button>
        </form>
      </div>
